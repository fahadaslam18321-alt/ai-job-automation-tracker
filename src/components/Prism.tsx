...
export const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const containerWithIO = container as HTMLDivElement & { __prismIO?: IntersectionObserver };
    ...
    return () => {
      ...
      if (suspendWhenOffscreen) {
        const io = containerWithIO.__prismIO;
        if (io) io.disconnect();
        delete containerWithIO.__prismIO;
      }
